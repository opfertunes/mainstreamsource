        ...
        <div class="container">
          <div class="row align-items-center justify-content-center">
            ...
            >
              ...
              <!-- <p>
                <a href="#" class="btn btn-primary px-4 py-3">Download Template</a>
              </p>-->
            </div>
          </div>
        </div>
        ...
        <div class="container">
          ...
          <div class="site-block-retro d-block d-md-flex">
            ...
            <div class="col2 ml-auto">
              <a
                href="#"
                class="col2-row1 unit-9 no-height"
                data-aos="fade-up"
                data-aos-delay="200"
              >
                <div
                  class="image"
                  :style="{
                    backgroundImage: `url(${require(`@/assets/images/img_3.jpg`)})`,
                  }"
                ></div>
                <div class="unit-9-content">
                  <h2>Classic Songs For Classic People</h2>
              ...
              <a
                href="#"
                class="col2-row2 unit-9 no-height"
                data-aos="fade-up"
                data-aos-delay="300"
              >
                <div
        ...
        <div class="container" data-aos="fade-up">
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
              <div class="team-member">
                <img
                  :src="require('@/assets/images/person_5.jpg')"
                  alt="Image"
                  class="img-fluid"
                />
            ...
            <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
              <div class="team-member">
                <img
                  :src="require('@/assets/images/person_6.jpg')"
                  alt="Image"
                  class="img-fluid"
                />
