    ...
    return (function(e) {
          ...
          l = (function(e) {
            function t(e) {
              ...
              return (
                ...
                (i.states =
                  (a((n = {}), s, Object.create(i.stateBehaviors[s])),
                  a(n, o, Object.create(i.stateBehaviors[o])),
                  a(n, u, Object.create(i.stateBehaviors[u])),
                  n)),
                (i.analyser = null),
                (i.buffer = null),
                (i.filters = []),
                  ...
                  value: function(e, t, r) {
                    ...
                    for (o = 0; o < s; o++) {
                      ...
                      for (c = t; c <= r; c++) {
                        ...
                        (u[2 * c] = p),
                          (u[2 * c + 1] = d),
                          (0 == o || p > this.mergedPeaks[2 * c]) &&
                            (this.mergedPeaks[2 * c] = p),
                          (0 == o || d < this.mergedPeaks[2 * c + 1]) &&
              ...
              },
              {
                ...
                value: function(e, t) {
                  ...
                  var r = e.targetTouches
                    ...
                    s = void 0;
                  return (
                    !this.params.fillParent && i < a
                      ? (s = (r - n.left) * (this.params.pixelRatio / i) || 0) >
                          1 && (s = 1)
                      : (s =
                          (r - n.left + this.wrapper.scrollLeft) /
              ...
              },
              {
                ...
                value: function(e, t, r) {
                  ...
                  (e.start = e.waveCtx.canvas.offsetLeft / i || 0),
                    ...
                    this.style(e.waveCtx.canvas, { width: n + "px" }),
                      ...
                      var l = a ? 2 : 1,
                        ...
                        f =
                          ...
                          (null === i.params.barGap
                            ? Math.max(i.params.pixelRatio, ~~(h / 2))
                            : Math.max(
                                i.params.pixelRatio,
                ...
                value: function(e, t, r, n, i, a, s, o) {
                  if (t) {
                    ...
                    if (!(c > o || h < s)) {
                      ...
                      for (
                        t.beginPath(),
                          t.moveTo((f - c) * l + this.halfPixel, i + a),
                          p = f;
                        p < d;
                        p++
                      ) {
                  ...
                  return o.frame(function() {
                    if (e[0] instanceof Array) {
                      ...
                      if (a.params.splitChannels)
                        return (
                          a.setHeight(
                            s.length * a.params.height * a.params.pixelRatio
                          ),
      ...
      function(e, t) {
        e.exports = function(e, t, r) {
          ...
          function u() {
            ...
            l < t && l >= 0
              ? (n = setTimeout(u, t - l))
              : ((n = null), r || ((o = e.apply(a, i)), (a = i = null)));
          }
          null == t && (t = 100);
          var l = function() {
      ...
      function(e, t, r) {
        ...
        !(function() {
          ...
          n(e, [{ key: "create", value: function(e) {} }]),
            n(e, [
        ...
        var f = (function(e) {
          function t(e) {
            ...
            if (
              ...
              (r.util = i),
              (r.params = i.extend({}, r.defaultParams, e)),
              (r.container =
            ...
            var n = 0;
            return (
              (r._onResize = i.debounce(
                function() {
                  n == r.drawer.wrapper.clientWidth ||
            ...
            n(t, [
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  var r = e.instance;
                  return (
                    Object.getOwnPropertyNames(i.Observer.prototype).forEach(
                      function(e) {
              ...
              },
              {
                ...
                value: function() {
                  ...
                  if (this.params.partialRender) {
                    ...
                    (a = this.backend.getPeaks(r, n, i)),
                      this.drawer.drawPeaks(a, r, n, i);
